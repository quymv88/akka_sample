 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://ws.com/", wsdlLocation = "http://localhost:4444/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:4444/ws/hello?wsdl");
